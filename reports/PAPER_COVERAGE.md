...
**Current post-training audit:** [CONNECTED-003 / SCFE-004](CONNECTED-003/POST_BUILD_AUDIT.md).
The rows below preserve the earlier engineering-stage assessment, before direct
human teaching. Read the current audit for learned results and the latest papers.
